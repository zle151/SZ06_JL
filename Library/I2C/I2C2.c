...
uint8_t I2C2_write2(uint8_t addr, uint8_t reg, uint8_t* dat, uint32_t offset, uint32_t len){
...
void I2C2_init(){
  ...
  // I2C  ------------------------------------------
  rcu_periph_clock_enable(I2C2RCU);
  /* 重置 reset I2C */
  i2c_deinit(i2cx);
  /* 配置I2C的速度，低高电平的比例 configure I2C clock */
  i2c_clock_config(i2cx, I2C2_SPEED, I2C_DTCY_2);
