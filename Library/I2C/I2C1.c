...
uint8_t I2C1_write2(uint8_t addr, uint8_t reg, uint8_t* dat, uint32_t offset, uint32_t len){
...
void I2C1_init(){
  ...
  // I2C  ------------------------------------------
  rcu_periph_clock_enable(I2C1RCU);
  /* 重置 reset I2C */
  i2c_deinit(i2cx);
